...
# Hi there 👋 I'm Adwaith Dinesh

**Cloud Security Engineer in training** passionate about securing the cloud, building security tooling, and learning how systems are both built and attacked.

I'm an **Integrated M.Tech Computer Science & Engineering** student at **VIT-AP University** (Batch '29), focused on becoming a technically strong Cloud Security / Cybersecurity Engineer.

---

## 🎯 Career Focus
- **Cloud Security** (primary direction)
- **Security Engineering**
- **SOC / Blue Team** & **Defense**
- **Penetration Testing** & **Red Team** (offense to complement defense)
- **Secure System Development**

---

## 🛠️ Current Flagship Project — AWS CSPM Tool

A **Cloud Security Posture Management (CSPM)** tool that discovers AWS resources, checks them against **CIS AWS Foundations Benchmark**, maps to compliance frameworks, and scores your security posture.
...
![Adwaith's GitHub stats](https://github-readme-stats.vercel.app/api?username=adwaidhdinesh&show_icons=true&theme=github_dark&hide_border=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=adwaidhdinesh&layout=compact&theme=github_dark&hide_border=true)
...
## 🏆 CTF & Security Learning
- **OverTheWire Bandit** — Linux & security fundamentals
- **TryHackMe** — hands-on labs
- **Burp Suite** — web/API security
- University CTFs & security events (CipherSaga, Se7ven Inspired, Kubernetes Unboxed)

---

## 📫 Get in Touch
- 💼 **LinkedIn:** [adwaidhdinesh](https://www.linkedin.com/in/adwaidhdinesh/)
- 📧 **Email:** adwaidhdinesh2006@gmail.com

*Open to **Cloud Security / Cybersecurity internships** and opportunities.*

---

<sub>⭐ *Always learning. Building real skills, not just collecting certificates.*</sub>